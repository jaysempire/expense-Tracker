 ...
 <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Duza Lions</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
      ...
      Designed by <a href="">JaysEmpire</a>
    </div>
  </footer><!-- End Footer -->
  ...
  <script src="<?= $server_name ?>/assets/vendor/chart.js/chart.umd.js"></script>
  <script src="<?= $server_name ?>/assets/vendor/echarts/echarts.min.js"></script>
  <script src="<?= $server_name ?>/assets/vendor/quill/quill.js"></script>
  ...
  <script src="<?= $server_name ?>/assets/vendor/php-email-form/validate.js"></script>
